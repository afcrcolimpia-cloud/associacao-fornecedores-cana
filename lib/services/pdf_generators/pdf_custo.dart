...
class PdfCustoOperacional {
    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
            _cabecalho(propriedade, font, fontBold, logoImage, cenario.nomeCenario),
            pw.SizedBox(height: 14),
            _parametros(cenario, font, fontBold),
            pw.SizedBox(height: 10),
            _resumoFinanceiro(cenario, font, fontBold),
          ],
        ),
      ),
    );
  ...
  static pw.Widget _cabecalho(
      Propriedade prop, pw.Font font, pw.Font bold, pw.MemoryImage logo, String cenarioNome) {
    return pw.Column(
  ...
  static pw.Widget _parametros(CustoOperacionalCenario cenario, pw.Font font, pw.Font bold) {
    return pw.Table(
      border: pw.TableBorder.all(color: PdfColors.grey600, width: 0.8),
      columnWidths: {
      ...
      children: [
        ...
        pw.TableRow(children: [
          _td('Produtividade', font),
          _td('${cenario.produtividade} t/ha', font),
          _td('ATR', font),
          _td('${cenario.atr} kg/t', font),
        ]),
        pw.TableRow(children: [
          _td('Preço Diesel', font),
          _td('R\$ ${cenario.precoDiesel?.toStringAsFixed(2) ?? "0.00"}', font),
          _td('Preço ATR', font),
          _td('R\$ ${cenario.precoAtr?.toStringAsFixed(4) ?? "0.0000"}', font),
        ]),
      ],
    );
  }
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              pw.Text('Cenário: ${cenario.nomeCenario}', style: pw.TextStyle(font: font, fontSize: 9)),
              pw.Text('Data Geração: ${DateTime.now().toString().substring(0, 10)}',
                  style: pw.TextStyle(font: font, fontSize: 9)),
            ],
          ),
          pw.Text('Relatório técnico de viabilidade financeira do cenário de produção.',
